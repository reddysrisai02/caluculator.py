...
btn_clear = Button(mw, text='C', padx=74, pady=10, font=('Arial', 14), command=clear)
...
btn_equal = Button(mw, text='=', padx=36, pady=10, font=('Arial', 14), command=equal)
...
btn_equal.grid(row=4, column=3, padx=2, pady=2)

btn_clear.grid(row=4, column=0, columnspan=2, padx=2, pady=2)
